// Icons remapped from beUI's lucide-react defaults to Solar (see docs/solarIcons.md).
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 flex items-start justify-center p-4 pt-[18vh]">
        <motion.div
          ...
          onKeyDown={onKeyDown}
          className={cn(
            "w-full max-w-xl overflow-hidden rounded-2xl bg-card shadow-2xl will-change-transform",
            open ? "pointer-events-auto" : "pointer-events-none",
          )}
        >
          <div className="flex items-center gap-3 px-4">
            ...
            />
            <kbd className="hidden rounded bg-background px-1.5 py-0.5 text-xs text-muted-foreground sm:inline-block">
              ESC
            </kbd>
          </div>
          <div
                  ...
                  {list.map((it) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {it.hint ? (
                          <kbd className="relative z-10 rounded bg-background px-1.5 py-0.5 text-xs text-muted-foreground">
                            {it.hint}
                          </kbd>
                        ) : null}
                      </button>
